...
export const EditForm = ({ showModal, setShowModal, selectedRow, reservations}) => {
  ...
  let initialState = {
    name: selectedRow ? reservationToEdit.name : "",
    email: selectedRow ? reservationToEdit.email : "",
    phone: selectedRow ? reservationToEdit.phone : "",
    pax: selectedRow ? reservationToEdit.pax : "",
    date: selectedRow ? reservationToEdit.date : "",
    time: selectedRow ? reservationToEdit.time : "",
  };
