...
export const EditForm = ({ showModal, setShowModal, selectedRow, reservations}) => {
  ...
  //console.log(reservationToEdit.name)
  ...
  let initialState = {
    name: reservations ? reservationToEdit.name : "",
    email: reservations ? reservationToEdit.email : "",
    phone: reservations ? reservationToEdit.phone : "",
    pax: reservations ? reservationToEdit.pax : "",
    date: reservations ? reservationToEdit.date : "",
    time: reservations ? reservationToEdit.time : "",
  };
